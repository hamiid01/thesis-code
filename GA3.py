...
import selection_function_tournament
import crossover_2_point
...
def genetic_algorithm(N, P, config, population):
    ...
    for generation in range(config['num_generations']):
        ...
        #        Fitness Evaluation
        #        logging.info("start fitness calculation")
        ...
        # Selection
        parents = selection_function_tournament.tournament_selection(population, fitness, int(len(population)//1.5))
        #  parents = [ [, , , , ], ..., [, , , , ] ]

        # crossover
        offspring = crossover_2_point.crossover(parents)
